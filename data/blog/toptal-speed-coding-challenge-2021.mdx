...
After all the problems are solved, it was time to start automating the submission. First approach I took was a script to submit the solutions in the browser.
